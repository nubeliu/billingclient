...
@utils.arg('--billing-user',
           help='Indicates that the report will be available for '
                'billing_user.',
           required=False)
...
def do_report_definition_create(cc, args):
    out = cc.metrics.reports.create(
        name=args.name, description=args.description, metrics=args.metrics,
        granularities=args.granularities,
        time_range_start=args.time_range_start,
        time_range_end=args.time_range_end,
        group_by=args.group_by, filters=args.filters,
...
@utils.arg('-t', '--term-duration',
           help='Not required. You can choose AWS term duration. This will '
                'affect the number of potential savings.  Default: 1_year. '
                'Available options: 1_year | 3_years_standard | '
                '3_years_convertible ',
           required=False, dest='term_duration')
@utils.arg('-o', '--offering-type',
           help='Not required. Choose AWS OfferingType. This will affect the '
                'number of potential savings. Default: no_upfront. Available '
